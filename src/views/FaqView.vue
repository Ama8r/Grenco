...
const rawFaqs = [
  {
    ...
    ar: {
      question: "ما هي أنواع البلاستيك التي يمكن لماكينات جرينكو معالجتها؟",
      answer:
  ...
  },
  {
    ...
    ar: {
      ...
      answer:
        "نعم، تأتي جميع ماكينات جرينكو بضمان قياسي لمدة عام يغطي عيوب التصنيع. نقدم أيضًا دعمًا شاملاً لما بعد البيع، بما في ذلك توفر قطع الغيار، وخدمات الصيانة، والدعم الفني عن بُعد.",
    },
  },
  {
    en: {
  ...
  },
  {
    ...
    ar: {
      ...
      answer:
        "تتصل ماكيناتنا المزودة بتقنية IoT بتطبيق جرينكو، مما يسمح لك بمراقبة معدلات الإنتاج واستهلاك الطاقة وحالة الماكينة في الوقت الفعلي. ستتلقى تنبيهات فورية للصيانة أو أي مشاكل تشغيلية.",
    },
  },
];
  ...
  <div class="page-wrapper">
    <div class="container section">
      ...
      >
        {{
          locale === "ar"
            ? "إجابات على استفساراتكم حول منتجات وخدمات جرينكو"

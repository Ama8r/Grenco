...
const toggleServiceSelection = (name: string) => {
  ...
  if (index === -1) {
    form.specificService.push(name);
  } else {
    form.specificService.splice(index, 1);
  }
};
...
const handleSubmit = async () => {
  ...
  const fullPhoneNumber = form.phone
    ? `${selectedCountry.value.code} ${form.phone}`
    : "";
  ...
  const payload: ContactPayload = {
    ...
    interest: form.serviceType === "product" ? "products" : "solutions",
    products: form.specificService,
  ...
  try {
    ...
    if (response.data.success) {
      successMessage.value = response.data.message || t("contact.success");
    ...
    if (error.response && error.response.data) {
      ...
      if (data.errors) {
        ...
        errorMessage.value = data.message || t("contact.error");
      }
    } else {
      errorMessage.value = t("contact.error");
    }
        ...
        <div class="contact-grid">
            ...
            <form class="contact-form" @submit.prevent="handleSubmit">
              ...
              <div class="form-group">
                ...
                <div class="service-toggle-container">
                  <div
                    class="toggle-slider"
                    :class="{ 'slide-right': form.serviceType === 'solution' }"
                  ></div>
                  <div
                    class="toggle-option"
                    :class="{ active: form.serviceType === 'product' }"
                    @click="setServiceType('product')"
                  >
                    <i class="pi pi-box"></i> {{ t("nav.products") }}
                  </div>
                  <div
                    class="toggle-option"
                    :class="{ active: form.serviceType === 'solution' }"
                    @click="setServiceType('solution')"
                  >
              ...
              <div class="form-group fade-in" v-if="availableOptions.length">
                ...
                <div class="options-grid">
                  <div
                    ...
                    class="option-card"
                    :class="{
                      active: form.specificService.includes(item.name),
                    }"
                  ...
                  >
                    <div class="checkbox-indicator">
                      <i
                        class="pi pi-check"
                        v-show="form.specificService.includes(item.name)"
                      ></i>
                    </div>
                ...
                <div class="error-message" v-if="errors.specificService">
                  {{ errors.specificService }}
                </div>
              </div>
          ...
          <div class="contact-info" data-aos="fade-left">
            ...
            <div class="map-container">
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d55805.67127046134!2d31.06078463387912!3d29.050885762042995!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x145a25e1064f72af%3A0xbacfa92a1eed60ea!2sBeni%20Suef%2C%20Qism%20Bani%20Sweif%2C%20Beni%20Suef%2C%20Beni%20Suef%20Governorate!5e0!3m2!1sen!2seg!4v1765587592841!5m2!1sen!2seg"
                width="600"
                height="450"
                style="border: 0"
                loading="lazy"

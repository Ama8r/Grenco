...
const heroImages = [
  ...
  'https://images.pexels.com/photos/5765/industry-recycling-garbage-waste.jpg'
]
...
.hero-overlay {
  ...
  background: linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.7)); z-index: 2;
}

.hero-container { position: relative; z-index: 3; padding-top: var(--space-7); }
.hero-content { max-width: 700px; }
.hero-title { font-size: clamp(var(--font-size-3xl), 5vw, var(--font-size-5xl)); margin-bottom: var(--space-3); line-height: 1.2; font-weight: 700; }
.hero-subtitle { font-size: clamp(var(--font-size-lg), 2vw, var(--font-size-xl)); margin-bottom: var(--space-5); max-width: 600px; opacity: 0.9; }
